...
type MultiEvaluateTestCase struct {
	TestCases []EvaluateTestCase
}

func (t *MultiEvaluateTestCase) RunAll(executable *interpreter_executable.InterpreterExecutable, logger *logger.Logger) error {
